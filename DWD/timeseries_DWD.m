...
if reloaddata
    ...
    websave(['data/' df '.zip'],'https://opendata.dwd.de/climate_environment/CDC/observations_germany/climate/hourly/air_temperature/historical/stundenwerte_TU_03987_18930101_20181231_hist.zip');
